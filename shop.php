    ...
    <div class="header-bg jumbotron-bg jumbotron page-bg" style="background-image: url('assets/img/Page-bg-bt.png'); height: auto;">
        <div class="text-head">
            <div class="w3-container w3-center w3-animate-zoom">
                <p class="text-3" style="font-size: 100%;">SHOP NOW</p>
            </div>
            <div class="container">
            <div class="w3-container w3-center w3-animate-zoom">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="index.php" role="button">
                            <i style="color: #009ce4 ;" class="glyphicon glyphicon-home"></i>
                        </a>
                    </div>

                    <div class="col-md-2">
                        <a href="manage.php" role="button">
                            <i style="color: #9d8d04;" class="glyphicon glyphicon-shopping-cart"></i>
                        </a>
                    </div>
