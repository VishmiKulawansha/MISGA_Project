    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarcollapse">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item" <?php if ($_SERVER['SCRIPT_NAME'] == "/shop.php") { ?> class="nav-item active" <?php   }  ?>>
                    <a href="shop.php" class="nav-link">Shop</a>
                </li>
                <li class="nav-item" <?php if ($_SERVER['SCRIPT_NAME'] == "/register.php") { ?> class="nav-item active" <?php   }  ?>>
